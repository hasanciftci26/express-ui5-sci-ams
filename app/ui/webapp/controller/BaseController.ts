...
import Component from "sap/sci/ams/ui/Component";
import formatter from "sap/sci/ams/ui/model/formatter";
...
export default abstract class BaseController extends Controller {
    ...
    public getText(key: string, args?: Array<string | number | boolean>) {
    ...
    public navTo(route: string, parameters?: Record<string, string | number | boolean | Date>, replace?: boolean) {
